...
const FAKE_ANNOUNCEMENT_BODY_ENV: &str = "MASTR_FAKE_PRODUCT_ANNOUNCEMENT_BODY";
const FAKE_ANNOUNCEMENT_BODY_FILE_ENV: &str = "MASTR_FAKE_PRODUCT_ANNOUNCEMENT_BODY_FILE";
const FAKE_ANNOUNCEMENT_ID_ENV: &str = "MASTR_FAKE_PRODUCT_ANNOUNCEMENT_ID";
const FAKE_ANNOUNCEMENT_TITLE_ENV: &str = "MASTR_FAKE_PRODUCT_ANNOUNCEMENT_TITLE";
