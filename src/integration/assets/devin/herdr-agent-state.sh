...
MASTR_HOOK_INPUT_FILE="$hook_input_file" python3 - <<'PY'
...
def load_session_list(project_dir: str | None):
    injected = os.environ.get("MASTR_DEVIN_LIST_JSON")
...
hook_input = load_hook_input(os.environ.get("MASTR_HOOK_INPUT_FILE"))
