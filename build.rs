...
fn main() {
    ...
    println!("cargo:rerun-if-env-changed=MASTR_BUILD_CHANNEL");
    println!("cargo:rerun-if-env-changed=MASTR_BUILD_ID");
    println!("cargo:rerun-if-env-changed=MASTR_BUILD_COMMIT");
